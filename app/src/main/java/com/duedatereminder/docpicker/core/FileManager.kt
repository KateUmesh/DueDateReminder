package com.duedatereminder.docpicker.core

import android.content.Context
import android.database.Cursor
import android.net.Uri
import androidx.core.content.FileProvider.getUriForFile
import com.duedatereminder.docpicker.ui.components.file.DocModel
import com.duedatereminder.docpicker.ui.components.folder.DocFolder
...
object FileManager : AnkoLogger {
    ...
    fun getContentUri(context: Context, newFile: File): Uri {
        val SHARED_PROVIDER_AUTHORITY = "com.duedatereminder.provider"
